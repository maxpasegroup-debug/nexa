...
import { BlizzwayBadge, BlizzwayButton, BlizzwayCard } from "@/components/blizzway";
  ...
  return (
    ...
    >
      ...
      <section className="mt-5 grid gap-5 xl:grid-cols-[1fr_0.42fr]">
        ...
        <div className="grid gap-5">
          <BlizzwayCard as="section" className="bg-slate-950 text-white">
          ...
          <BlizzwayCard as="section">
            ...
            <div className="mt-5 grid gap-3">
              {companion.outcomes.map((outcome) => (
                <BlizzwayBadge key={outcome} tone="slate" className="justify-center py-3">
                  {outcome}
                </BlizzwayBadge>
              ))}
            </div>
