...
import { BlizzwayBadge, BlizzwayButton, BlizzwayCard, BlizzwayEmptyState } from "@/components/blizzway";
import { BlizzwayApi, getApiErrorMessage, type BlizzwayAgent } from "@/lib/api";
...
function mapAgent(companion: BlizzwayAgent, index: number): StoreAgent {
  return {
    id: companion.id,
    slug: companion.slug,
  ...
  return (
    <article className="group flex h-full flex-col rounded-[22px] border border-slate-200 bg-white p-4 shadow-sm c7-lift-card">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-2">
            ...
            {companion.trending ? (
              <BlizzwayBadge tone="emerald" className="shrink-0 px-2 py-1 text-[11px]">
                Hot
              </BlizzwayBadge>
            ) : null}
          </div>
      ...
      <div className="mt-5 flex flex-1 items-end justify-between gap-3">
        ...
        <BlizzwayButton href={`/agent-store/${companion.slug}`} size="sm" variant="dark" className="min-w-20">
          Details
        </BlizzwayButton>
      </div>
    </article>
  ...
  return (
    ...
    >
      <section className="mt-5 grid gap-5 xl:grid-cols-[1fr_0.38fr]">
        ...
        <BlizzwayCard as="section" className="flex flex-col justify-between">
          <StoreSectionTitle
            eyebrow="Store pulse"
      ...
      <section className="mt-5">
        <BlizzwayCard as="div" className="p-4">
