...
import { BlizzwayBadge, BlizzwaySidebar, LogoutButton, type BlizzwayNavItem } from "@/components/blizzway";
...
export function BlizzwayDashboardShell({
  activeHref,
        ...
        <header className="rounded-[28px] bg-white/88 p-4 shadow-sm ring-1 ring-slate-200/70 backdrop-blur">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div>
              ...
              <BlizzwayBadge tone="indigo" dot className="mt-3">{eyebrow}</BlizzwayBadge>
