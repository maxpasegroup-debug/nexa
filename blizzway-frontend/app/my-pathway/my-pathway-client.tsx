...
import { BlizzwayBadge, BlizzwayCard, BlizzwayEmptyState, BlizzwayGradientPanel } from "@/components/blizzway";
import { BlizzwayApi, getApiErrorMessage, pathwayApi, type BlizzwayGrowthBoardResponse, type BlizzwayPathwayResponse } from "@/lib/api";
      ...
      <section className="mt-5 grid gap-5 xl:grid-cols-[0.9fr_1.1fr]">
        ...
        <BlizzwayCard as="section">
          <div className="flex items-start justify-between gap-3">
            ...
            <BlizzwayBadge tone="slate">Fallback</BlizzwayBadge>
          </div>
