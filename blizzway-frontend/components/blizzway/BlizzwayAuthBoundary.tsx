...
export function BlizzwayAuthBoundary({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    async function verifyBlizzwaySession() {
      try {
        await BlizzwayApi.getHealth();
