      ...
      <section className="mt-5 grid gap-5 xl:grid-cols-[1.18fr_0.82fr]">
        ...
        <Career7Card as="section">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Career7Badge tone="emerald">Private by design</Career7Badge>
            <Career7Badge tone="slate">No real encryption yet</Career7Badge>
          </div>
        </Career7Card>
      </section>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {timeline.map((item) => (
              <article key={item.range} className="rounded-[22px] border border-slate-200 bg-white p-5 shadow-sm">
                <Career7Badge tone="cyan">{item.range}</Career7Badge>
            ...
            {skillGaps.map((gap) => (
              <article key={gap.skill} className="rounded-[22px] border border-slate-200 bg-slate-50 p-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <Career7Badge tone="slate" className="self-start">{gap.level}</Career7Badge>
                </div>
