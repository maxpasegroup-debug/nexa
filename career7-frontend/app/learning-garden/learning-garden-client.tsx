...
import { Career7Badge, Career7Button, Career7Card, Career7EmptyState, Career7GradientPanel } from "@/components/career7";
import { career7Api, getApiErrorMessage, learningGardenApi, type Career7GrowthBoardResponse, type LearningGardenResponse } from "@/lib/api";
    ...
    >
      ...
      <section className="mt-5 grid gap-5 xl:grid-cols-[1fr_0.72fr]">
        ...
        <Career7Card as="section" className="c7-magical-glow">
          ...
          <Career7Button href="/magic-market" variant="secondary" className="mt-5">
            Add companion
          </Career7Button>
        </Career7Card>
      </section>
      ...
      <section className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {loading ? (
          ...
          companions.map((companion) => (
            <Career7Card key={companion.id} as="article" variant="companion" className="c7-lift-card">
              <Career7Badge tone="cyan">{companion.category}</Career7Badge>
          ...
          <Career7EmptyState title="No active learning companions" description="Add a learning companion from Magic Market to start your garden." />
        )}
      </section>
    </Career7DashboardShell>
  );
