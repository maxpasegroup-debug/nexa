...
import {
  ...
  type Career7GrowthBoardResponse,
  type Career7MetricsResponse,
  type Career7WalletResponse,
...
type DashboardData = {
  ...
  metrics: Career7MetricsResponse;
  wallet: Career7WalletResponse;
  growthBoard: Career7GrowthBoardResponse;
      ...
      <section className="mt-5 grid gap-5 xl:grid-cols-[1fr_0.82fr]">
        <Career7Card as="section">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <Career7Badge tone={data.fallbackLabels.length ? "slate" : "purple"}>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            {derived.progressCards.map(({ title, value, description, fallback }) => (
              <div key={title} className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                ...
                <p className="mt-3 text-sm leading-6 c7-muted">{description}</p>
                {fallback ? <Career7Badge tone="slate" className="mt-3">Fallback</Career7Badge> : null}
              </div>
            ))}
          </div>
        </Career7Card>
      ...
      <section className="mt-5 grid gap-5 xl:grid-cols-[0.9fr_1.1fr]">
        <Career7Card as="section">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <Career7Badge tone="cyan">{derived.magicalSteps.length} steps</Career7Badge>
          </div>
          <div className="mt-6 space-y-3">
          ...
          {derived.previews.map(({ title, href, stat, description, fallback }) => (
            <Link key={title} href={href} className="c7-card c7-lift-card block p-5">
              <div className="flex items-center justify-between gap-3">
                ...
                {fallback ? <Career7Badge tone="slate">Fallback</Career7Badge> : null}
              </div>
