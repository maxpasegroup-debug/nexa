...
import { career7Api, getApiErrorMessage } from "@/lib/api";
import {
  ...
  return (
    <Career7Card as="article" variant="companion" className="flex h-full flex-col c7-lift-card">
      ...
      <div className="mt-5 flex items-center justify-between gap-3">
        ...
        <Career7Button href={`/agent-store/${item.slug}`} variant={item.recommended ? "primary" : "dark"} size="sm">
          Details
        </Career7Button>
      </div>
    </Career7Card>
      ...
      <section className="mt-5">
        ...
        <div className="mt-5">
          {loading ? (
            ...
            <Career7EmptyState title="No companions found" description="BGOS returned no Blizzway marketplace agents for this view." />
          )}
        </div>
      </section>
