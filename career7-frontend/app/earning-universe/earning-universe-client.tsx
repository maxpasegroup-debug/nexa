...
import { career7Api, earningUniverseApi, getApiErrorMessage, type Career7GrowthBoardResponse, type EarningUniverseResponse } from "@/lib/api";
        ...
        <Career7Card as="section">
          ...
          <div className="mt-6 grid gap-3">
            {loading ? (
              ...
              <Career7EmptyState title="No earning opportunities yet" description="Add earning companions to build your opportunity pipeline." />
            )}
          </div>
        </Career7Card>
