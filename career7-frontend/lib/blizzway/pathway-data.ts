import type { Career7Agent, Career7GrowthBoardItem } from "@/lib/api";
import {
...
export function boardItemsToMilestones(items: Career7GrowthBoardItem[]): PathwayMilestone[] {
...
export function agentToLearningCompanion(agent: Career7Agent, index: number): LearningCompanion {
...
export function agentToEarningOpportunity(agent: Career7Agent): EarningOpportunity {
